...
{/* Hero Section */}
<div className="flex flex-col md:flex-row items-center justify-center px-26 max-w-6xl mx-auto relative z-10 min-h-screen">
    <div className="md:w-3/4 text-right md:text-right flex flex-col items-end md:items-start justify-end">
    ...
    <div className="md:w-1/4  mt-10 md:mt-0 flex justify-end items-right">
        <img
            src={profilePic}
            alt="Harsh Srivastav"
            className="w-84 h-84 object-cover rounded-lg shadow-md border border-gray-200"
        />
    </div>
</div>
